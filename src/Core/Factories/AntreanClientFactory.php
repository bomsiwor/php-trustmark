...
final class AntreanClientFactory implements ClientFactoryInterface
{
    public function createClient(array $config): ClientContract
    {
        ...
        return self::factory(AntreanClient::class)
    ...
    {
        return match ($env) {
            'production' => 'antreanrs',
            'development' => 'antreanrs_dev',
        };
    }
